...
## :bulb: Overview
The main goal of this project is to build a data engineering pipeline to regularly transform a messy database into a clean source of truth for an analytics team. This project utilizes Databricks, delta live tables, airflow, and dbt (data build tool) to manage and transform data daily. 
## :scroll: Scenario
